...
FUNCTION CSI_READ_ENVI_IMAGE, filename, HEADER=header, OUTPUT_INTERLEAVE=outputInterleave
...
;-
   header = CSI_READ_ENVI_HEADER( headerFilename )
...
; VIVIANO-- this messes with the values in the image... commenting out for now
